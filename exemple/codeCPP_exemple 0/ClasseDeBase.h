...
///
/////////////////////////////////////////////////
class ClasseDeBase : public popo::ClasseC, public popo::ClasseA {
...
protected:
    ...
    pipi::ClasseB m_composition;     ///< associé avec le type: 'composition', créer un simple attribut. #G#S
    std::shared_ptr<pipi::ClasseB> m_aggregation;     ///< associé avec le type: 'Aggregation'. Créer l'attribut dans un shared_ptr. En mettant #G ou #S dans le commentaire d'un attribut on indique a dia2code  de prevoir les fonctions get ou set dans le *.h.
